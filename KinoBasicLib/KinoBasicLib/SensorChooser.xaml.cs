...
namespace KinoBasicLib
{
    ...
    /// </summary>
    public partial class SensorChooser : UserControl
    {
        public static readonly DependencyProperty KinectProperty =
            DependencyProperty.Register("Kinect", typeof(KinectSensor), typeof(SensorChooser), new UIPropertyMetadata(null, new PropertyChangedCallback(KinectPropertyChanged)));

        public static readonly DependencyProperty MessageProperty =
            DependencyProperty.Register("Message", typeof(string), typeof(SensorChooser), new UIPropertyMetadata(null));

        public static readonly DependencyProperty MoreInfoProperty =
            DependencyProperty.Register("MoreInfo", typeof(string), typeof(SensorChooser), new UIPropertyMetadata(null));

        public static readonly DependencyProperty MoreInfoUriProperty =
            DependencyProperty.Register("MoreInfoUri", typeof(Uri), typeof(SensorChooser), new UIPropertyMetadata(null));

        public static readonly DependencyProperty ShowRetryProperty =
            DependencyProperty.Register("ShowRetry", typeof(bool), typeof(SensorChooser), new UIPropertyMetadata(false));
        ...
        {
            SensorChooser sensorChooser = (SensorChooser)d;
